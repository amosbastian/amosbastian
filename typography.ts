  ...
  return {
    ...
    DEFAULT: {
      css: {
        ...
        "--tw-prose-underline": theme("colors.zinc.800 / 0.2"),
        "--tw-prose-underline-hover": theme("colors.zinc.800"),
        ...
        "--tw-prose-invert-underline": theme("colors.zinc.200 / 0.3"),
        "--tw-prose-invert-underline-hover": theme("colors.zinc.200"),
